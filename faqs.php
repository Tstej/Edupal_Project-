<!DOCTYPE html>
<!-- saved from url=(0049)https://codyhouse.co/demo/faq-template/index.html -->
...
<head>
  ...
  <script async="" src="./FAQ Template_files/analytics.js.download"></script>
  <script>
...
<body>
  <header class="cd-header flex flex-column flex-center">
    <div class="text-component text-center">
      <h1 style=font-weight:bold;color:black>FAQs</h1>
    </div>
  </header>
  <section class="cd-faq js-cd-faq container max-width-md margin-top-lg margin-bottom-lg">
    ...
    <div class="cd-faq__items">
      <ul id="basics" class="cd-faq__group">
        ...
        <li class="cd-faq__item">
          <a class="cd-faq__trigger" href=""><span>What is Edupal?</span></a>
          <div class="cd-faq__content">
            <div class="text-component">
              <p>Edupal is an online platform that aims to connect educators, learners, and employers in a way that's beneficial to each and every party, and focuses on digital, business, and workplace skills. Programming languages, software, web design, digital marketing, productivity and time management – you get the gist!</p>
            </div>
          </div>
        </li>
        <li class="cd-faq__item">
          <a class="cd-faq__trigger" href=""><span>Can we access this website on Mobile?</span></a>
          <div class="cd-faq__content">
            <div class="text-component">
              <p>Yes, you can browse this website on any device such as desktops, laptops, mobile with any-screen size. This is a responsive website in nature, so you can still enjoy a clean beautiful interface of the website on any device with a browser and decent internet connectivity. There are no restrictions around the world.</p>
            </div>
          </div>
        </li>
        <li class="cd-faq__item">
          <a class="cd-faq__trigger" href=""><span>How can I find out which institutions are rated best for a specific course?</span></a>
          <div class="cd-faq__content">
            <div class="text-component">
              <p>You can easily find it out by searching the course name in our list institution section.</p>
            </div>
          </div>
        </li>
        <li class="cd-faq__item">
          <a class="cd-faq__trigger" href=""><span>What is gamification in education?</span></a>
          <div class="cd-faq__content">
            <div class="text-component">
              <p>Gamification is a way to make learning more interactive & fun. Game makers have spent years on trying to make their content more enjoyable for users. Rewards, achievements, and other features often associated with games can be used in education to increase motivation.</p>
            </div>
          </div>
        </li>
        <li class="cd-faq__item">
          <a class="cd-faq__trigger" href=""><span>Is online education as effective as face-to-face instruction?</span></a>
          <div class="cd-faq__content">
            <div class="text-component">
        ...
        <li class="cd-faq__item">
          <a class="cd-faq__trigger" href=""><span>How do I know if online education is right for me?</span></a>
          <div class="cd-faq__content">
            <div class="text-component">
              <p> Choosing the right degree program takes time and careful research no matter how one intends to study. Learning styles, goals, and programs always vary, but students considering online platforms to learn must consider technical skills, ability to self-motivate, and other factors specific to the medium. </p>
            </div>
          </div>
        </li>
      </ul>
      <ul id="account" class="cd-faq__group">
        ...
        <li class="cd-faq__item">
          <a class="cd-faq__trigger" href=""><span>Why can't I login to your website?</span></a>
          <div class="cd-faq__content">
            <div class="text-component">
              <p>Incorrect Username or Password. Verify your username and password is being entered correctly. *Tip: Avoid using saved, autofill or suggested usernames/passwords that your browser/device may suggest and try manually entering your credentials. If you have forgotten your password, you can use the Forgot Password link. </p>
            </div>
          </div>
        </li>
        <li class="cd-faq__item">
          <a class="cd-faq__trigger" href=""><span>How do I change my password?</span></a>
          <div class="cd-faq__content">
            <div class="text-component">
              <p>We have not added service to change the password yet. We will add it soon.</p>
            </div>
          </div>
        </li>
      </ul>
      <ul id="privacy" class="cd-faq__group">
        ...
        <li class="cd-faq__item">
          <a class="cd-faq__trigger" href=""><span>Is it a Safe and Friendly website?</span></a>
          <div class="cd-faq__content">
            <div class="text-component">
              <p>Yes, it’s a totally safe and friendly website with no pop ads, no adult content, or unwanted articles. we have also taken security measures to safeguard our visitors by adding an SSL Certificate to our website for a secure and safe connection.</p>
            </div>
          </div>
        </li>
        <li class="cd-faq__item">
          <a class="cd-faq__trigger" href=""><span>Is Edupal planning to add other education fields in its platform?</span></a>
          <div class="cd-faq__content">
            <div class="text-component">
              <p>At the moment, we are focusing on digital skills such as programming/design/business, and marketing. However, we are planning to add more education fields to our platform soon. Stay up to date by following our social media!</p>
            </div>
          </div>
        </li>
      </ul>
      <ul id="contact" class="cd-faq__group">
        <li class="cd-faq__title">
          <h2>Contact</h2>
        </li>
        <li class="cd-faq__item">
          <a class="cd-faq__trigger" href=""><span>How do I contact you if my questions aren't answered here?</span></a>
          <div class="cd-faq__content">
            <div class="text-component">
              <p>Email us at www.contactedupal@gmail.com. We will be sure to back to you within 24 hours. Please leave a contact number and the best time to call just in case we need to speak further.</p>
            </div>
          </div>
        </li>
        <li class="cd-faq__item">
          <a class="cd-faq__trigger" href=""><span>Where are you located?</span></a>
          <div class="cd-faq__content">
            <div class="text-component">
              <p>We are situated in Pune, India.</p>
            </div>
          </div>
        </li>
    ...
    <a href="https://codyhouse.co/demo/faq-template/index.html#0" class="cd-faq__close-panel text-replace">Close</a>
  ...
  <script>
    (function() {
      ...
      function getBannerHTML() {
        return '<div class="demo-avd__close"></div> <a href="https://nucleoapp.com/?ref=2214" class="demo-avd__template-img"> <img src="../../assets/img/sponsor/nucleo-adv-demo-1.jpg" alt="Nucleo logo"> </a> <a href="https://nucleoapp.com/?ref=2214" class="demo-avd__template-text"> Nucleo is a free app to organize your icons and export them as icon fonts and SVG symbols. </a>';
      };
