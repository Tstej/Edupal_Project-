...
<body>
  ...
  <div class="container">
    ...
    <?php $result4 = mysqli_query($conn, "SELECT * from esignup,eplatform where eplatform.epno=esignup.epno and epname='" . $pname . "' order by cdate desc limit 6");
      ...
      <div class="box">
        ...
        <p class="text"><?php echo $row4['ecomments']; ?></p>
      </div>
